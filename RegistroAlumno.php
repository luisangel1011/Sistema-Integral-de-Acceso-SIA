    ...
    <main class="contenido-principal">
        <div class="CentroFormulario">
            <div class="Recuadro_perfil RegistroAlumno">
                ...
                <div>
                    <label style="color:white;">Carga académica (horario escolar):</label>
                    <input type="file" class="carga_academica" accept="image/*" required>
                </div>


                <div class="boton-formulario"><button class="btnRegistroAlumno">Registrar Usuario</button></div>
            </div>
        </div>
