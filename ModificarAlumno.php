...
<body class="Sistema">
            ...
            <div class="ContenedorModAlumno">
                ...
                <div class="ListaAlumnos">
                    <div class="BuscadorWrapper">
                        <input type="text" class="BuscadorAlumno" placeholder="Buscar Usuario..." title="Buscar por identificador,nombre, correo_electronico y Genero">
                    </div>
                    <div class="Listado">
                        ...
                        <!--
                        <div class="ItemAlumno"><label for="">ISC211927 - Juan Pérez</label></div>
                        <div class="ItemAlumno"><label for="">ISC211928 - María López</label></div>
                        <div class="ItemAlumno"><label for="">ISC211929 - Carlos Ramírez</label></div>
                        <div class="ItemAlumno"><label for="">ISC211930 - Elena García</label></div>
                        -->
                    </div>
                </div>
    ...
    <script>
        $(document).ready(async function() {
            ...
            $(document).on("click", ".ItemAlumno", function() {
